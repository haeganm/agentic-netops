...
| Lambda (8 functions, arm64) | free tier covers demo volume many times over |
...
| CloudWatch | explicit 7-day log retention on every function; 3 alarms + 1 metric filter (all inside the free tier) |
